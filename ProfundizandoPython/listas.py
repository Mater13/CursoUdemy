...
# slicing
numeros2 = numeros1[1:4]  # Incluye en Start, pero no el End
print(f'Misma referencia? {numeros1 is numeros2}')
print(f'Mismo contenido? {numeros1 == numeros2}')
print(f'numeros2 con Start:End>>> {numeros2}')

# Multiplicación listas
lista_multiplicacion = 5*[[2, 5]]
print(lista_multiplicacion)
print(f'Misma refecia: {lista_multiplicacion[0] is lista_multiplicacion[1]}')
